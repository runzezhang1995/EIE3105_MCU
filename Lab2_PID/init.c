...
void TIM3_CH12_PWM_init(){
	...
	TIM_InitStruct.TIM_Prescaler = 1440-1; // 72000000 / 72 = 1000000
	TIM_InitStruct.TIM_CounterMode = TIM_CounterMode_Up;
	TIM_InitStruct.TIM_Period = 100-1; // 1 us x 500 = 0.5ms
...
void TIM2_Init(){
	...
	TIM_InitStruct.TIM_CounterMode = TIM_CounterMode_Up;
	TIM_InitStruct.TIM_Period = 10000-1; // 100ms
	TIM_InitStruct.TIM_ClockDivision = TIM_CKD_DIV1; 
	TIM_InitStruct.TIM_RepetitionCounter = 0;
